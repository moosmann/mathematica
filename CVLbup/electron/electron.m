...
(* ::Input:: *)
SetDirectory["/home/julian/mathematica/electron"];
ClearSystemCache[];
Needs["Splines`"];
...
Subscript[curve, num][u_]:=10Sqrt[\[Pi]/area](initialcurve[u]-centroid);
Subscript[inilen, num]=10Sqrt[\[Pi]/area]length;

Show[
ListPlot[10Sqrt[\[Pi]/area]Table[xy[[i]]-centroid,{i,1,n}],PlotStyle->{Red,PointSize[Medium]},AspectRatio->Full],
...
Show[
ListPlot[10Sqrt[\[Pi]/area]Table[xy[[i]]-centroid,{i,1,n}],PlotStyle->{Black,PointSize[Medium]},AspectRatio->Full],
ListPlot[Table[Subscript[curve, num][2Pi i/100],{i,0,100}],AspectRatio->Full],
...
dist,dmin,l1,l2,l,i,j,d,
newdist,nnew,newX,newY,newgrid,
xmdp,ymdp,order=12,xexp,yexp,xfk,yfk,xpara,ypara,yfitdat,xfitdat,fc},
