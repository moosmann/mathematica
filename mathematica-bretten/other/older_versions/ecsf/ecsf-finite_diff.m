...
Subscript[curve, num,1][u_]:=10Sqrt[2\[Pi]/area](initialcurve[u]-centroid);
...
NIntegrate[initialcurve[u] Sqrt[Evaluate[(\!\(
\*SubscriptBox[\(\[PartialD]\), \(u\)]\(initialcurve[u]\)\)).(\!\(
\*SubscriptBox[\(\[PartialD]\), \(u\)]\(initialcurve[u]\)\))]],{u,0,2\[Pi]},AccuracyGoal->8];
...
area=1/2 
NIntegrate[Evaluate[(x)( \!\(
\*SubscriptBox[\(\[PartialD]\), \(u\)]y\))-(y)(\!\(
\*SubscriptBox[\(\[PartialD]\), \(u\)]x\))],{u,0,2\[Pi]}
];
length=NIntegrate[Sqrt[Evaluate[(\!\(
\*SubscriptBox[\(\[PartialD]\), \(u\)]x\))^2+(\!\(
\*SubscriptBox[\(\[PartialD]\), \(u\)]y\))^2]],{u,0,2\[Pi]}];
cen=1/length NIntegrate[Evaluate[{x,y}  Sqrt[(\!\(
\*SubscriptBox[\(\[PartialD]\), \(u\)]x\))^2+(\!\(
\*SubscriptBox[\(\[PartialD]\), \(u\)]y\))^2]],{u,0,2\[Pi]},AccuracyGoal->8,MaxRecursion->20]
];
